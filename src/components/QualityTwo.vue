<template>
    <div class="index">
      <div class="body1">
        ...
        <div class="body_bottom" v-if="open_folds">
          <el-form ref="forms" :model="formData" label-width="130px">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item :label="'引用监测\n数据数值'" class="item" style="margin:0;white-space: pre-line;line-height: 20px;">
              ...
              <el-col :span="8"><el-form-item label="项目名称" style="margin:0">
                  <el-select v-model="formData.data_sources" placeholder="请选择" style="width: 100%">
                    <el-option
                      v-for="item in sourcesData"
                      :key="item.value"
      ...
      <div class="body1">
        ...
        <div class="body_bottom histogram_body_bottom">
          ...
          <el-col :span="24"><div class="histogram" id="histogram" :style="histogram"></div></el-col>
          <el-col :span="24">
            <el-table
                :data="tableData"
  ...
  .index .body1 .histogram_body_bottom{padding: 0 0 60px 0;overflow: hidden;
    .histogram_bottom{display: flex;justify-content:end;margin:30px 150px 0 0;
      .bottom_div div{float: left;}
      .max_zhi{width: 16px;height: 10px;background: #4B9FFA;display: block;margin: 6px 10px 0 0;}
      .min_zhi{width: 16px;height: 10px;background: #4CC473;display: block;margin: 6px 10px 0 20px;}
      .san{width: 16px;height: 10px;background: #FAB221;display: block;margin: 6px 10px 0 20px;}
    }
  }
