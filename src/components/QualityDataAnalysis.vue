...
export default {
  ...
  data () {
    return {
      ...
      yData:[{max:39,min:31},{max:38,min:31}, {max:38,min:31},{max:38,min:31},
        {max:38,min:31},{max:38,min:31},{max:38,min:31},{max:38,min:31}],
...
.index .body1 .histogram_body_bottom{height: 380px;padding: 0 0 60px 0;overflow: hidden;
  .histogram_bottom{display: flex;justify-content: center;
